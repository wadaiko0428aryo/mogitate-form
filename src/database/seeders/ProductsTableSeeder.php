...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $fruits = [
            'name' => 'キウイ',
            'price' => '800',
            'image' => 'storage/app/public/fruits-img/kiwi.png',
        ...
        $fruits = [
            'name' => 'ストロベリー',
            'price' => '1200',
            'image' => 'storage/app/public/fruits-img/strawberry.png',
        ...
        $fruits = [
            'name' => 'オレンジ',
            'price' => '850',
            'image' => 'storage/app/public/fruits-img/orange.png',
        ...
        $fruits = [
            'name' => 'スイカ',
            'price' => '700',
            'image' => 'storage/app/public/fruits-img/watermelon.png',
        ...
        $fruits = [
            'name' => 'ピーチ',
            'price' => '1000',
            'image' => 'storage/app/public/fruits-img/peach.png',
        ...
        $fruits = [
            'name' => 'シャインマスカット',
            'price' => '1400',
            'image' => 'storage/app/public/fruits-img/muscat.png',
        ...
        $fruits = [
            'name' => 'パイナップル',
            'price' => '800',
            'image' => 'storage/app/public/fruits-img/pineapple.png',
        ...
        $fruits = [
            'name' => 'ブドウ',
            'price' => '1100',
            'image' => 'storage/app/public/fruits-img/grapes.png',
        ...
        $fruits = [
            'name' => 'バナナ',
            'price' => '600',
            'image' => 'storage/app/public/fruits-img/banana.png',
        ...
        $fruits = [
            'name' => 'メロン',
            'price' => '900',
            'image' => 'storage/app/public/fruits-img/melon.png',
