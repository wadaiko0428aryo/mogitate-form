...
<nav>
    <ul class="pagination">
        ...
        <?php else: ?>
        <li>
            <a class="pagination__link" href="<?php echo e($paginator->previousPageUrl()); ?>" rel="prev"
...
<?php endif; ?><?php /**PATH /var/www/resources/views/vendor/pagination/custom.blade.php ENDPATH**/ ?>